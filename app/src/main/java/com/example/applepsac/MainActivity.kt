...
fun SplashScreenContent() {
    Column(
        ...
        // Aquí puedes agregar tu contenido del Splash Screen, como una imagen o un logotipo
        Image(
            painter = painterResource(id = R.drawable.splash), // Asegúrate de tener splash.png en res/drawable
